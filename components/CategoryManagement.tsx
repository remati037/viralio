    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-slate-800 border border-slate-700 rounded-md py-3 px-4 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="space-y-2">
        {categories.length === 0 ? (
          <div className="text-center py-8 text-slate-500 border-2 border-dashed border-slate-800 rounded-lg">
            ...
            <p>Nemate kategorija. Dodajte prvu kategoriju.</p>
          </div>
        ) : (
          <div className="flex flex-wrap gap-2">
            {categories.map((category) => (
              <div
                key={category.id}
                className="group bg-slate-800 border border-slate-700 rounded-md py-2 px-3 flex items-center justify-center gap-2 hover:border-slate-600 transition-colors"
              >
                {editingId === category.id ? (
                  ...
                  <>
                    ...
                    />
                    <span
                      className="text-white cursor-pointer leading-6"
                      onClick={() => {
