    ...
    try {
      ...
      if (result.error) {
        ...
        toast.success('Mock podaci dodati!', {
          description:
            '3 studije slučaja su dodate. Osvežite stranicu da ih vidite.',
        });
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1">
                  <div className="w-full bg-slate-800 rounded-xl overflow-hidden aspect-video border border-slate-700 flex items-center justify-center relative">
                    ...
                    <span
                      className={`absolute top-2 left-2 px-2 py-0.5 text-[10px] rounded-full font-bold ${
                ...
                <div className="md:col-span-2">
                  ...
                  <h3 className="text-md font-bold text-slate-300 mb-2 flex items-center gap-2">
                    <Lightbulb size={16} className="text-blue-400" /> Ključna
                    Analiza:
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-4 mt-4 pt-3 border-t border-slate-800">
                    <div className="flex items-center gap-1 text-xs text-emerald-400">
                      <Eye size={14} />{' '}
                      <span>{task.result_views || 'N/A'}</span>
                    </div>
                    <div className="flex items-center gap-1 text-xs text-purple-400">
                      <Heart size={14} />{' '}
                      <span>{task.result_engagement || 'N/A'}</span>
                    </div>
                    <div className="flex items-center gap-1 text-xs text-yellow-400">
                      <Target size={14} />{' '}
                      <span>{task.result_conversions || 'N/A'}</span>
                    </div>
                  </div>
                </div>
              </div>
