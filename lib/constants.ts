...
export const KANBAN_COLUMNS = [
  {
    ...
    color: 'border-chart-3/50 bg-chart-3/10 text-chart-3',
  },
  {
    id: 'ready',
    ...
    color: 'border-chart-1/50 bg-chart-1/10 text-chart-1',
  },
  {
    id: 'scheduled',
    title: 'Zakazano',
    ...
    color: 'border-chart-4/50 bg-chart-4/10 text-chart-4',
  },
  {
    id: 'published',
    title: 'Objavljeno',
    ...
    color: 'border-chart-2/50 bg-chart-2/10 text-chart-2',
  },
]
